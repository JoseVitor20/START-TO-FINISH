...
@section('content')
    ...
    <div class="contract-container">
        ...
        <div class="section-title">CLÁUSULA 4 - DO REEMBOLSO</div>
        ...
        <div class="section-title">CLÁUSULA 5 - DAS OBRIGAÇÕES DO PRESTADOR DE SERVIÇOS</div>
        <ul class="sub-clause-list">
        ...
        <div class="section-title">CLÁUSULA 6 - DO PAGAMENTO E DA VIGÊNCIA</div>
        ...
        <div class="section-title">CLÁUSULA 7 - DO FORO</div>
