...
<body style="background-color: #0f0f13; color: #ffffff; font-family: 'Segoe UI', system-ui, sans-serif; margin: 0; padding: 14px;">

    <div style="max-width: 600px; margin: 0 auto; background-color: #1e1e2a; border: 1px solid #2d2d42; border-radius: 16px; box-shadow: 0 4px 14px rgba(0, 0, 0, 0.3); overflow: hidden;">
        
        <!-- Header -->
        <div style="background: linear-gradient(135deg, #1a1a24, #1900df); padding: 30px 14px; text-align: center; position: relative;">
        ...
        <div style="padding: 40px;">
            ...
            @if($planName == 'price_1Rtd6DATrxUtVNls55TD2FwV')
                <div style="margin-bottom: 30px;">
                    @if($endsAt && $endsAt !== 'Data de término do ciclo não definida')
                        <p style="font-size: 12px; color: #ffffff; line-height: 1.7; margin-bottom: 14px;">
                    ...
                    <h3 style="color: #00f5d0; font-size: 14px; margin-top: 30px; margin-bottom: 10px;">Benefícios que você irá perder:</h3>
            ...
            @elseif($planName == 'price_1Rtd6zATrxUtVNlslxYeAk0i')
                <div style="margin-bottom: 30px;">
                    @if($endsAt && $endsAt !== 'Data de término do ciclo não definida')
                        <p style="font-size: 10px; color: #ffffff; line-height: 1.7; margin-bottom: 14px;">
            ...
            @if($endsAt && $endsAt !== 'Data de término do ciclo não definida')
            <p style="font-size: 10px; color: #a0a0c0; line-height: 1.7; margin-bottom: 14px;">
            ...
            <div style="text-align: center; margin: 40px 0;">
                <a href="{{ route('dashboard') }}" style="background: linear-gradient(135deg, #00f5d0, #19bf00); color: #000000; padding: 16px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; display: inline-block; font-size: 10px; box-shadow: 0 0 15px rgba(0,245,208,0.4); transition: all 0.4s cubic-bezier(0.68, -0.55, 0.27, 1.55);">
                    Acessar Minha Conta
                </a>
            </div>
