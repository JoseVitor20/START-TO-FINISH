...
<body style="background-color: #0f0f13; color: #ffffff; font-family: 'Segoe UI', system-ui, sans-serif; margin: 0; padding: 20px;">
    ...
    <div class="container" style="max-width: 600px; margin: 0 auto; background-color: #1e1e2a; border: 1px solid #2d2d42; border-radius: 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.3); overflow: hidden;">
        ...
        <div class="content" style="padding: 40px;">
            <h1 class="plan-title" style="color: #00f5d0; font-size: 16px; margin-bottom: 25px; font-weight: 600; position: relative; display: inline-block;">
            ...
            @if($planName == 'price_1Rtd6DATrxUtVNls55TD2FwV')
                <div style="margin-bottom: 30px;">
                    <p class="plan-cancellation-text" style="font-size: 12px; color: #ffffff; line-height: 1.7; margin-bottom: 20px;">
                    ...
                    <h3 class="benefits-heading" style="color: #e0e0e0; font-size: 18px; margin-bottom: 15px;">Ao cancelar, você perde os seguintes benefícios:</h3>
            ...
            @elseif($planName == 'price_1Rtd6zATrxUtVNlslxYeAk0i')
                <div style="margin-bottom: 30px;">
                    <p class="plan-cancellation-text" style="font-size: 16px; color: #ffffff; line-height: 1.7; margin-bottom: 20px;">
            ...
            <p class="plan-cancellation-text" style="font-size: 16px; color: #a0a0c0; line-height: 1.7; margin-bottom: 20px;">
