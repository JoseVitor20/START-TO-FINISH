        ...
        <div style="padding: 40px;">
            ...
            @elseif($planName == 'price_1Rtd6zATrxUtVNlslxYeAk0i')
                <div style="margin-bottom: 30px;">
                    ...
                    @endif
                    <div style="text-align: center; margin: 20px 0;">
                        <img src="{{ asset('img/starttofinish-white.png') }}" alt="Plano Básico" style="max-width: 100%; border-radius: 8px; border: 1px solid #2d2d42;">
                    </div>
                    <h3 style="color: #00f5d0; font-size: 20px; margin-top: 30px; margin-bottom: 10px;">Benefícios que você irá perder:</h3>
                    <ul style="list-style-type: none; padding-left: 0;">
            ...
            @elseif($planName == 'price_1Rt8A5PSFtrJEyUPWvDK3zVT')
                <div style="margin-bottom: 30px;">
                    ...
                    @endif
                    <div style="text-align: center; margin: 20px 0;">
                        <img src="{{asset('img/assinaturas/plano-avancado.png')}}" alt="Plano Avançado" style="max-width: 100%; border-radius: 8px; border: 1px solid #2d2d42;">
                    </div>
                    <h3 style="color: #00f5d0; font-size: 20px; margin-top: 30px; margin-bottom: 10px;">Benefícios que você irá perder:</h3>
                    <ul style="list-style-type: none; padding-left: 0;">
