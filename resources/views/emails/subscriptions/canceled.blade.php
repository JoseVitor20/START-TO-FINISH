        ...
        <div style="padding: 40px;">
            ...
            @if($planName == 'price_1Rtd6DATrxUtVNls55TD2FwV')
                <div style="margin-bottom: 30px;">
                    ...
                    <div style="text-align: center; margin: 20px 0;">
                        <img src="{{asset('img/assinaturas/plano-micro.png')}}" alt="Plano Micro" style="border-radius: 8px; border: 1px solid #2d2d42;">
                    </div>
            ...
            @elseif($planName == 'price_1Rtd6zATrxUtVNlslxYeAk0i')
                <div style="margin-bottom: 30px;">
                    ...
                    @endif
                    <div style="text-align: center; margin: 20px 0;">
                        <img src="{{asset('img/assinaturas/plano-basico.png')}}" alt="Plano Básico" style="border-radius: 8px; border: 1px solid #2d2d42;">
                    </div>
                    <h3 style="color: #00f5d0; font-size: 20px; margin-top: 30px; margin-bottom: 10px;">Benefícios que você irá perder:</h3>
                    <ul style="list-style-type: none; padding-left: 0;">
            ...
            @elseif($planName == 'price_1Rt85EPSFtrJEyUPK8H2s7E7')
                <div style="margin-bottom: 30px;">
                    ...
                    @endif
                    <div style="text-align: center; margin: 20px 0;">
                        <img src="{{asset('img/assinaturas/plano-essencial.png')}}" alt="Plano Essencial" style="border-radius: 8px; border: 1px solid #2d2d42;">
                    </div>
                    <h3 style="color: #00f5d0; font-size: 20px; margin-top: 30px; margin-bottom: 10px;">Benefícios que você irá perder:</h3>
                    <ul style="list-style-type: none; padding-left: 0;">
            ...
            @elseif($planName == 'price_1Rt86VPSFtrJEyUPfUS70vfM')
                <div style="margin-bottom: 30px;">
                    ...
                    @endif
                    <div style="text-align: center; margin: 20px 0;">
                        <img src="{{asset('img/assinaturas/plano-profissional.png')}}" alt="Plano Profissional" style="border-radius: 8px; border: 1px solid #2d2d42;">
                    </div>
                    <h3 style="color: #00f5d0; font-size: 20px; margin-top: 30px; margin-bottom: 10px;">Benefícios que você irá perder:</h3>
                    <ul style="list-style-type: none; padding-left: 0;">
            ...
            @elseif($planName == 'price_1Rt8A5PSFtrJEyUPWvDK3zVT')
                <div style="margin-bottom: 30px;">
                    ...
                    @endif
                    <div style="text-align: center; margin: 20px 0;">
                        <img src="{{asset('img/assinaturas/plano-avancado.png')}}" alt="Plano Avançado" style="border-radius: 8px; border: 1px solid #2d2d42;">
                    </div>
                    <h3 style="color: #00f5d0; font-size: 20px; margin-top: 30px; margin-bottom: 10px;">Benefícios que você irá perder:</h3>
                    <ul style="list-style-type: none; padding-left: 0;">
            ...
            @elseif($planName == 'price_1Rt8BWPSFtrJEyUPaF7RDRjt')
                <div style="margin-bottom: 30px;">
                    ...
                    @endif
                    <div style="text-align: center; margin: 20px 0;">
                        <img src="{{asset('img/assinaturas/plano-master.png')}}" alt="Plano Master" style="border-radius: 8px; border: 1px solid #2d2d42;">
                    </div>
                    <h3 style="color: #00f5d0; font-size: 20px; margin-top: 30px; margin-bottom: 10px;">Benefícios que você irá perder:</h3>
                    <ul style="list-style-type: none; padding-left: 0;">
